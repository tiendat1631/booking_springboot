...
const TIME_SLOTS = [
    { id: "morning", label: "Sáng", range: "06:00 - 12:00", start: 6, end: 12 },
    { id: "afternoon", label: "Chiều", range: "12:00 - 18:00", start: 12, end: 18 },
    { id: "evening", label: "Tối", range: "18:00 - 24:00", start: 18, end: 24 },
] as const;

// Đảm bảo ID khớp với enum BusType trong hệ thống của bạn
const BUS_TYPES = [
    { id: "SEATER", label: "Ghế ngồi", icon: Armchair },
    { id: "SLEEPER", label: "Giường nằm", icon: BedDouble },
