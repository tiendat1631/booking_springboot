...
public class TripSeat extends BaseEntity {
    ...
    /**
     * Calculate final seat price (trip price + adjustment)
     */
    public BigDecimal getFinalPrice(BigDecimal tripBasePrice) {
        if (priceAdjustment == null) {
            return tripBasePrice;
        }
        return tripBasePrice.add(priceAdjustment);
    }
